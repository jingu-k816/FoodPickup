  ...
  router.post("/:id", (req, res) => {
   ...
   `
    ...
    if (req.query.status === "incomplete") {
      ...
      // client.messages
      // .create({body: `Hi there! Your food will be ready in ${processingTime} minutes.`, from: '+12343198009', to: '+1911'})
      // .then(message => console.log(message.sid));
    }
    ...
    if (req.query.status === "complete"){
      ...
      // client.messages
      // .create({body: 'Hi there Your food is ready Please come and pick it up!', from: '+12343198009', to: '+1911'})
      // .then(message => console.log(message.sid));
    }
